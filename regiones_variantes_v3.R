...
metada_covid <- read_excel(file_in)

start <- ymd("2021-12-01")
end <- as.Date("2022-07-16")
...
metada_covid <- metada_covid %>%
  mutate(linajeOMS=case_when(Linaje== "B.1.1.7" ~ "Alpha", Linaje=="B.1.1.519" ~ "B.1.1.519", Linaje=="B.1.1.222" ~ "B.1.1.222",
                               ...
                               Linaje=="BA.1"~"BA.1", Linaje=="BA.1.1"~"BA.1.1", Linaje=="BA.1.1.1"~"BA.1.1.1",Linaje=="BA.1.1.10"~"BA.1.1.10",Linaje=="BA.1.1.14"~"BA.1.1.14",
                               Linaje=="BA.1.1.15"~"BA.1.1.15",Linaje=="BA.1.1.16"~"BA.1.1.16",Linaje=="BA.1.1.18"~"BA.1.1.18",Linaje=="BA.1.1.2"~"BA.1.1.2",Linaje=="BA.1.1.6"~"BA.1.1.6",
                               Linaje=="BA.1.13"~"BA.1.13",Linaje=="BA.1.14"~"BA.1.14",Linaje=="BA.1.14.1"~"BA.1.14.1",Linaje=="BA.1.14.2"~"BA.1.14.2", 
                               ...
                               Linaje=="BA.1.17"~"BA.1.17", Linaje=="BA.1.17.2"~"BA.1.17.2",  Linaje=="BA.1.18"~"BA.1.18",Linaje=="BA.1.19"~"BA.1.19", Linaje=="BA.1.20"~"BA.1.20", Linaje=="BA.1.21"~"BA.1.21",  Linaje=="BA.1.6"~"BA.1.6",
                               ...
                               Linaje=="BA.2.22"~"BA.2.22",Linaje=="BA.2.23"~"BA.2.23", Linaje=="BA.2.23.1"~"BA.2.23.1", Linaje=="BA.2.3"~"BA.2.3",Linaje=="BA.2.3.10"~"BA.2.3.10",Linaje=="BA.2.3.15"~"BA.2.3.15",Linaje=="BA.2.3.17"~"BA.2.3.17", Linaje=="BA.2.3.2"~"BA.2.3.2",Linaje=="BA.2.3.4"~"BA.2.3.4", Linaje=="BA.2.3.6"~"BA.2.3.6",Linaje=="BA.2.31"~"BA.2.31",Linaje=="BA.2.36"~"BA.2.36",Linaje=="BA.2.37"~"BA.2.37",Linaje=="BA.2.38"~"BA.2.38",
                               Linaje=="BA.2.4"~"BA.2.4",Linaje=="BA.2.40"~"BA.2.40", Linaje=="BA.2.40.1"~"BA.2.40.1",Linaje=="BA.2.49"~"BA.2.49",Linaje=="BA.2.52"~"BA.2.52",Linaje=="BA.2.56"~"BA.2.56",Linaje=="BA.2.57"~"BA.2.57",Linaje=="BA.2.6"~"BA.2.6", Linaje=="BA.2.62"~"BA.2.62",Linaje=="BA.2.65"~"BA.2.65",Linaje=="BA.2.66"~"BA.2.66",Linaje=="BA.2.71"~"BA.2.71", Linaje=="BA.2.72"~"BA.2.72",Linaje=="BA.2.8"~"BA.2.8",
                               Linaje=="BA.2.9"~"BA.2.9",Linaje=="BA.2.9.3"~"BA.2.9.3",Linaje=="BA.4"~"BA.4",
                               Linaje=="BA.4.1"~"BA.4.1",Linaje=="BA.4.1.1"~"BA.4.1.1",Linaje=="BA.5"~"BA.5",Linaje=="BA.5.1"~"BA.5.1",Linaje=="BA.5.2"~"BA.5.2",Linaje=="BA.5.2.1"~"BA.5.2.1",Linaje=="BA.5.3"~"BA.5.3",Linaje=="BA.5.3.1"~"BA.5.3.1",Linaje=="BA.5.5"~"BA.5.5",Linaje=="BB.2"~"BB.2", Linaje=="BE.1"~"BE.1", Linaje=="BF.1"~"BF.1",Linaje=="BG.1"~"BG.1",Linaje=="BG.2"~"BG.2",
                               TRUE  ~ "Other"))
...
filter2<-filter(filter1, percentage>5)
...
ggplot(data=db_variante_percentage, aes(x=week_final)) + geom_bar(aes(y=percentage,fill=Variant),stat = "identity") + theme(axis.text.x = element_text(angle = 90)) + scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
dev.off()
...
#Northeast5<-ggplot(Northeast4, aes(Mes_recoleccion, n, fill = linajeOMS)) + geom_bar(stat = "identity") + theme_bw()+ theme(axis.text.x = element_text(angle = 90, hjust = 1)) + scale_fill_manual(values = color)+ggtitle("Northeast")+theme(legend.text = element_text(size=5))
Northeast5<-ggplot(Northeast4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Noreste Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
Northwest5<-ggplot(Northwest4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Noroeste Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
#Central_North5<-ggplot(Central_North4, aes(Mes_recoleccion, n, fill = linajeOMS)) + geom_bar(stat = "identity") + theme_bw() + theme(axis.text.x = element_text(angle = 90, hjust = 1))+ scale_fill_manual(values = color)+ggtitle("Central_North")+theme(legend.text = element_text(size=5))
Central_North5<-ggplot(Central_North4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Centro Norte Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
Central_South5<-ggplot(Central_South4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Centro Sur")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
West5<-ggplot(West4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Oeste Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
Southeast5<-ggplot(Southeast4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Sureste Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
...
#Southeast5<-ggplot(Southeast4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start =
...
South5<-ggplot(South4, aes(Mes_recoleccion, percentage, fill = linajeOMS))+geom_bar(stat="identity")+ coord_polar(start = 0)+ ggtitle("Sur Mexico")+theme_void()+scale_fill_manual(values = color)+theme(legend.text = element_text(size=5))
